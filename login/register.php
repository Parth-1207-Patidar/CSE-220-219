...
<body class="bg-[url(../assets/OIP.jpg)] bg-cover bg-center h-screen flex items-center justify-center">
    <form method="post" action="./backend/action.php" class="backdrop-blur-md p-6 rounded shadow-md w-full max-w-sm" onsubmit="return validateForm()">
        ...
        <div class="mb-4">
            ...
            <input class="shadow border rounded w-full py-2 px-3 text-white bg-gray-800" id="email" name="email" type="email" placeholder="Enter your email">
        ...
        <div class="mb-4">
            ...
            <input class="shadow border rounded w-full py-2 px-3 text-white bg-gray-800" name="confirmPassword" id="confirmPassword" type="password" placeholder="Enter your password again">
            <p id="confirmPasswordError" class="text-red-500 text-sm mt-1 hidden"></p>
        </div>

        <div class="mb-4">
            <p class="text-white flex gap-2">Already have an account? <a href="index.php" class="hover:cursor-pointer">Login here</a></p>
        </div>
